...
if __name__ == "__main__":
    ...
    sampler = MAGNN_sampler(
        ...
        metapath_list=model.metapath_list,
    ...
    for epoch in range(args.max_epoch):
        ...
        for num_iter, (sub_g, mini_mp_inst, seed_nodes) in enumerate(dataloader):
            print(
                "Sampling {} seed_nodes with duration(s): {}".format(
                    len(seed_nodes[args.category]), time.perf_counter() - t
                )
            )
            ...
            print(
                "Iter:{}, the training loss of this batch is {}".format(
                    num_iter, loss.item()
                )
            )
            t = time.perf_counter()
        ...
        with th.no_grad():
            ...
            print(
                ...
                + ", ".join(
                    [
                        "{:.6f}~{:.6f} ({:.1f})".format(
                            macro_f1[0], macro_f1[1], train_size
                        )
                        for macro_f1, train_size in zip(
                            val_f1_macro_list, [0.8, 0.6, 0.4, 0.2]
                        )
                    ]
                )
            )
            print(
                ...
                + ", ".join(
                    [
                        "{:.6f}~{:.6f} ({:.1f})".format(
                            micro_f1[0], micro_f1[1], train_size
                        )
                        for micro_f1, train_size in zip(
                            val_f1_micro_list, [0.8, 0.6, 0.4, 0.2]
                        )
                    ]
                )
            )
        ...
        print(
            ...
            + ", ".join(
                [
                    ...
                    for macro_f1, train_size in zip(
                        test_f1_macro_list, [0.8, 0.6, 0.4, 0.2]
                    )
                ]
            )
        )
        print(
            ...
            + ", ".join(
                [
                    ...
                    for micro_f1, train_size in zip(
                        test_f1_micro_list, [0.8, 0.6, 0.4, 0.2]
                    )
                ]
            )
        )
