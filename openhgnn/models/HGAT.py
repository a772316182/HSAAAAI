    ...
    def __init__(self, num_layers, hidden_dim, num_classes, ntypes, negative_slope):
        ...
        for l in range(num_layers - 1):
            ...
            self.hgat_layers.append(
                NodeAttention(hidden_dim, hidden_dim, negative_slope)
            )
    ...
    def forward(self, hg, h_dict):
        ...
        with hg.local_scope():
            ...
            for l in range(self.num_layers):
                ...
                h = self.hgat_layers[2 * l + 1](
                    g, g.ndata["h"], g.ndata["_TYPE"], g.ndata["_TYPE"], presorted=True
                )
