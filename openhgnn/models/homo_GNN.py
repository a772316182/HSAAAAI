...
class homo_GNN(BaseModel):
    ...
    def __init__(self, args, hg, out_node_type, **kwargs):
        ...
        if args.layers_pre_mp - 1 > 0:
            self.pre_mp = HGNNPreMP(
                args, hg.ntypes, args.layers_pre_mp, args.hidden_dim, args.hidden_dim
            )
        ...
        self.post_mp = HGNNPostMP(
            args, self.out_node_type, args.layers_post_mp, gnn_out_dim, args.out_dim
        )
