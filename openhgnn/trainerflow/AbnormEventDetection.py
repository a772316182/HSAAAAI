...
class AbnormEventDetection(BaseFlow):
    ...
    def __init__(self, args=None):
        ...
        args.center_type, args.context_type = (
            self.task.dataset.center_type,
            self.task.dataset.context_type,
        )
    ...
    def _full_train_step(self):
        ...
        (
            ...
            event_mask,
            type_num,
        ) = self.task.dataset.get_batch(self.batch_size, device=self.device)
