...
class hde_trainer(BaseFlow):
    ...
    def __init__(self, args):
        ...
        self.sample_size = self.num_fea * (
            1 + args.num_neighbor + args.num_neighbor * args.num_neighbor
        )
        ...
        (
            ...
            self.test_batch_y,
        ) = self.HDE_sampler.compute_hde(args)
    ...
    def _mini_train_step(
        ...
        self.model.train()
        all_loss = 0
        for train_batch_A_fea, train_batch_B_fea, train_batch_y in zip(
