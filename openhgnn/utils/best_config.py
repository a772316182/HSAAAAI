BEST_CONFIGS = {
    "node_classification": {
        "RGCN": {
            ...
            "HGBn-ACM": {"evaluation_metric": "f1"},
            "HGBn-DBLP": {"num_layers": 2, "hidden_dim": 16, "dropout": 0.5},
            "HGBn-Freebase": {"num_layers": 5, "hidden_dim": 16, "dropout": 0.5},
            "HGBn-IMDB": {},
            "ohgbn-Freebase": {
                "lr": 0.005,
                "weight_decay": 0.0001,
            ...
            "ohgbn-yelp2": {
                "lr": 0.001,
                "hidden_dim": 64,
                "dropout": 0.3696343130196993,
                "num_layers": 3,
                "use_self_loop": True,
                "n_bases": 3,
            },
            "alircd_session1": {"lr": 0.001, "hidden_dim": 64, "dropout": 0.49},
        },
        "CompGCN": {
            "general": {
                "seed": 0,
        ...
        "HPN": {
            ...
            "ohgbn-imdb": {"lr": 0.005, "hidden_dim": 128, "dropout": 0.25},
        },
        "NARS": {
            "general": {},
            "HGBn-ACM": {
        ...
        "HeCo": {
            "general": {"hidden_dim": 64, "max_epoch": 10000, "mini_batch_flag": False},
            "acm4HeCo": {
                "seed": 84,
                "eva_lr": 0.05,
                "eva_wd": 0,
                ...
                "feat_drop": 0.3,
                "attn_drop": 0.5,
                "sample_rate": {"author": 7, "subject": 3},
                "lam": 0.5,
            },
        },
        "DMGI": {
            "general": {"seed": 0, "sc": 3, "learning_rate": 0.0005},
            "acm_han_raw": {
                "weight_decay": 0.0001,
                "dropout": 0.5,
                "reg_coef": 0.001,
        ...
        "SimpleHGN": {
            ...
            "ohgbn-Freebase": {
                "lr": 0.001,
                "hidden_dim": 128,
                "dropout": 0.16263095198267938,
                "num_heads": 4,
                "feats_drop_rate": 0.13286688066111216,
                "edge_dim": 32,
            },
        },
        "RGAT": {
